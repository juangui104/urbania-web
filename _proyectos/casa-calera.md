...
galeria:
  ...
  - /assets/images/proyectos/casa-calera-3.webp
  - /assets/images/proyectos/casa-calera-4.webp
  - /assets/images/proyectos/casa-calera-5.webp
  - /assets/images/proyectos/casa-calera-6.webp
destacado: true
descripcion_corta: "Construcción completa de vivienda unifamiliar en el sector de La Calera, Medellín. Desde excavación y estructura hasta acabados finales y entrega de llaves."
proyecto_siguiente_url: /proyectos/cantero/
proyecto_siguiente_nombre: Apartamento Cantero
---

<div style="display:grid; grid-template-columns:1fr 1fr; gap:var(--space-12); margin-top:var(--space-8);" class="desc-grid">

  <div class="animate-fade-left">
    <h2 style="font-family:var(--font-display); font-size:var(--text-3xl); color:var(--color-blanco); line-height:1.2; margin-bottom:var(--space-6);">
      El reto
    </h2>
